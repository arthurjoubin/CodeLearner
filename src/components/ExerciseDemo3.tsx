...
export function ExerciseDemo3({ onComplete }: { onComplete?: () => void }) {
  ...
  const initialSegments = [
    ...
    { text: 'function ', cls: 'text-cyan-600' },
    { text: 'Counter', cls: 'text-gray-900 font-bold' },
    { text: '() {\n', cls: 'text-gray-800' },
    { text: '  ', cls: 'text-gray-800' },
    { text: 'let', cls: 'text-red-600 font-bold' },
    { text: ' count = ', cls: 'text-gray-800' },
    { text: '0', cls: 'text-blue-600' },
    { text: ';\n', cls: 'text-gray-800' },
    { text: '  return ', cls: 'text-cyan-600' },
    { text: '(\n    <', cls: 'text-gray-800' },
    { text: 'button', cls: 'text-cyan-700' },
    { text: ' onClick={', cls: 'text-gray-800' },
    { text: '() => ', cls: 'text-gray-800' },
    { text: 'count++', cls: 'text-red-600 font-bold' },
    { text: '}>\n', cls: 'text-gray-800' },
    { text: '      Clicks: {count}\n', cls: 'text-gray-800' },
    { text: '    </', cls: 'text-gray-800' },
    { text: 'button', cls: 'text-cyan-700' },
  ...
  const fixSegments = [
    { text: '\n\n', cls: '' },
    { text: '// Fix: use React state\n', cls: 'text-gray-500' },
    { text: 'const ', cls: 'text-cyan-600' },
    { text: '[count, setCount]', cls: 'text-gray-800' },
    { text: ' = ', cls: 'text-gray-800' },
    { text: 'useState', cls: 'text-cyan-600 font-bold' },
    { text: '(', cls: 'text-gray-800' },
    { text: '0', cls: 'text-blue-600' },
    { text: ');\n', cls: 'text-gray-800' },
    { text: 'setCount', cls: 'text-cyan-600' },
    { text: '(prev => prev + ', cls: 'text-gray-800' },
    { text: '1', cls: 'text-blue-600' },
    { text: ');', cls: 'text-gray-800' },
  ];
  ...
  const hintText = "let won't trigger re-render! Use useState so React can track and update the UI.";
    ...
    switch (phase) {
      case 'typing':
        timer = setTimeout(
          ...
          typedChars < totalInitialChars ? 30 : 1000
        );
        break;
      case 'analyzing':
      ...
      case 'hint':
        timer = setTimeout(
          ...
          hintChars < hintText.length ? 22 : 2000
        );
        break;
      case 'fixing':
        timer = setTimeout(
          () => fixChars < totalFixChars ? setFixChars(c => c + 1) : setPhase('reanalyzing'),
          fixChars < totalFixChars ? 35 : 1200
        );
        break;
      case 'reanalyzing':
  ...
  return (
    <div className={`border-2 rounded-lg bg-white max-w-2xl overflow-hidden transition-colors duration-500 ${isValidated ? 'border-cyan-400' : 'border-gray-300'}`}>
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-200 bg-gray-50">
        <div className="w-3 h-3 rounded-full bg-red-400" />
        <div className="w-3 h-3 rounded-full bg-yellow-400" />
        <div className="w-3 h-3 rounded-full bg-cyan-400" />
        <span className="ml-2 text-[10px] text-gray-400 uppercase font-bold tracking-wider">Counter.tsx</span>
      </div>
      ...
      <div className="px-4 py-3 border-t border-gray-200 bg-gray-50 min-h-[44px] flex items-center">
        ...
        {phase === 'typing' && typedChars > 0 && (
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500 font-medium">Writing React component...</span>
          </div>
        )}
        {(phase === 'analyzing' || phase === 'reanalyzing') && (
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 border-2 border-cyan-500 border-t-transparent rounded-full animate-spin" />
            <span className="text-xs text-cyan-600 font-bold">AI is analyzing your code...</span>
          </div>
        )}
        {phase === 'hint' && (
        ...
        {phase === 'validated' && (
          <div className="flex items-center gap-2 animate-pop">
            ...
            <span className="text-xs text-cyan-700 font-bold">Code validated! +150 XP earned</span>
          </div>
        )}
      </div>
    </div>
