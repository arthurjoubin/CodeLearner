          ...
          <div className="flex items-center justify-between h-16">
            ...
            {isGuest ? (
              <div className="flex items-center gap-2 sm:gap-3">
                <a
                  href="/learning-path"
                  className={`hidden sm:flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all border ${
                    (currentPath.startsWith('/learning-path') || currentPath.startsWith('/module') || currentPath.startsWith('/lesson') || currentPath.startsWith('/exercise') || currentPath.startsWith('/quiz'))
                      ? 'text-primary-600 bg-primary-50/50 border-primary-200'
                ...
                <a
                  href="/login"
                  className="flex items-center gap-2 bg-gray-900 text-white px-5 py-2 text-sm font-medium hover:bg-gray-800 transition-all rounded-lg ml-2 shadow-sm hover:shadow"
                >
                  <span>Login</span>
                </a>
                <button
                  onClick={() => setMenuOpen(!menuOpen)}
                  className="sm:hidden p-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all rounded-lg border border-transparent hover:border-gray-200"
                  title="Menu"
                >
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="fixed inset-x-0 top-0 z-50 bg-white border-b-2 border-gray-100 sm:hidden animate-slide-down">
                      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                        <span className="text-lg font-bold tracking-wider text-gray-900 font-mono">HACK<span className="text-primary-500">UP</span></span>
                        <button onClick={() => setMenuOpen(false)} className="p-2 hover:bg-gray-50 rounded-lg transition-colors border border-transparent hover:border-gray-200">
                          <X className="w-5 h-5" />
                        </button>
                      </div>
                      <nav className="px-3 py-3 space-y-1">
                        <a
                          ...
                          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all border ${
                            currentPath.startsWith('/learning-path') ? 'bg-primary-50/50 border-primary-200 text-primary-700' : 'border-transparent text-gray-700 hover:bg-gray-50 hover:border-gray-200'
                          }`}
                        >
                        ...
                        <a
                          ...
                          onClick={() => setMenuOpen(false)}
                          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all border ${
                            currentPath.startsWith('/courses') ? 'bg-primary-50/50 border-primary-200 text-primary-700' : 'border-transparent text-gray-700 hover:bg-gray-50 hover:border-gray-200'
                          }`}
                        >
                        ...
                        <a
                          ...
                          onClick={() => setMenuOpen(false)}
                          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all border ${
                            currentPath.startsWith('/resources') ? 'bg-primary-50/50 border-primary-200 text-primary-700' : 'border-transparent text-gray-700 hover:bg-gray-50 hover:border-gray-200'
                          }`}
                        >
                        ...
                        <a
                          ...
                          onClick={() => setMenuOpen(false)}
                          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all border ${
                            currentPath.startsWith('/codecraft') ? 'bg-primary-50/50 border-primary-200 text-primary-700' : 'border-transparent text-gray-700 hover:bg-gray-50 hover:border-gray-200'
                          }`}
                        >
                        ...
                        <a
                          ...
                          onClick={() => setMenuOpen(false)}
                          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all border ${
                            currentPath === '/pricing' ? 'bg-primary-50/50 border-primary-200 text-primary-700' : 'border-transparent text-gray-700 hover:bg-gray-50 hover:border-gray-200'
                          }`}
                        >
                      ...
                      <div className="px-4 py-4 border-t border-gray-100">
                        <a
                          href="/login"
                          onClick={() => setMenuOpen(false)}
                          className="block w-full text-center bg-gray-900 text-white px-4 py-3 text-sm font-medium hover:bg-gray-800 transition-all rounded-lg shadow-sm"
                        >
                          Login
                        </a>
                      </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {pathLessons.length > 0 && (
                <div className="relative hidden md:block">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary-600 bg-white border border-gray-200 hover:border-primary-300 rounded-lg transition-all shadow-sm hover:shadow"
                  >
              ...
              <a 
                ...
                className={`hidden sm:flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all border ${
                  currentPath.startsWith('/lab')
                    ? 'text-primary-600 bg-primary-50/50 border-primary-200'
                    : 'text-gray-600 hover:text-primary-600 bg-white border-gray-200 hover:border-primary-300 shadow-sm hover:shadow'
                }`}
                title="Labs"
              >
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 text-sm font-medium hover:bg-gray-800 transition-all rounded-lg shadow-sm hover:shadow"
                >
                ...
                {streakPopupOpen && (
                  <>
                    ...
                    <div className="absolute right-0 mt-3 w-56 bg-white border border-gray-100 rounded-xl shadow-lg shadow-gray-200/60 z-50 overflow-hidden">
                      <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 bg-gray-50/30">
                        <Flame className="w-4 h-4 text-orange-500" />
                        <span className="font-medium text-xs text-gray-700 uppercase tracking-wider font-mono">Streak</span>
                        <span className="ml-auto text-primary-600 font-bold font-mono">{user.streak} days</span>
                      </div>
                      <div className="p-4 space-y-3 text-xs">
                        <p className="text-gray-600">Daily practice keeps your streak alive.</p>
                        <div className="space-y-1.5">
                          <p className="font-medium text-gray-700 text-[10px] uppercase tracking-wider font-mono">XP Bonus</p>
                          <div className="flex justify-between text-gray-600">
                            <span>7+ days</span>
                            <span className="text-primary-600 font-mono font-semibold">+10%</span>
                          </div>
                          <div className="flex justify-between text-gray-600">
                            <span>30+ days</span>
                            <span className="text-primary-600 font-mono font-semibold">+25%</span>
                          </div>
                          <div className="flex justify-between text-gray-600">
                            <span>100+ days</span>
                            <span className="text-primary-600 font-mono font-semibold">+50%</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 border border-gray-200 px-4 py-2 text-sm font-medium hover:bg-gray-50 transition-all rounded-lg bg-white shadow-sm hover:shadow"
                >
                  <span className="text-xs text-gray-500 uppercase hidden sm:inline font-mono">{levelInfo.title}</span>
                  <span className="text-gray-900 font-mono">Lvl {levelInfo.level}</span>
                </button>
                {levelPopupOpen && (
                  <>
                    <div className="fixed inset-0 z-40" onClick={() => setLevelPopupOpen(false)} />
                    <div className="absolute right-0 mt-3 w-64 bg-white border border-gray-100 rounded-xl shadow-lg shadow-gray-200/60 z-50 overflow-hidden">
                      <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 bg-gray-50/30">
                        <div className="w-2 h-2 bg-primary-500 rounded-full" />
                        <span className="font-medium text-xs text-gray-700 uppercase tracking-wider font-mono">{levelInfo.title}</span>
                        <span className="ml-auto text-primary-600 font-bold text-xs font-mono">{user.xp} XP</span>
                      </div>
              ...
              <div className="relative">
                <button
                  onClick={() => setMenuOpen(!menuOpen)}
                  className="p-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all rounded-lg border border-transparent hover:border-gray-200"
                  title="Menu"
                >
                  {menuOpen ? <X className="w-5 h-5" /> : <Menu className="w-5 h-5" />}
                </button>
