  ...
  return (
    <div className="page-enter">
      <div className="relative inline-block group mb-4">
        <Link to="/" className="inline-flex items-center gap-2 text-gray-800 font-bold uppercase hover:text-primary-600 transition-colors">
        ...
        {courseModules.map((module, index) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-[10px] text-gray-700 font-bold mt-1 ml-4">{completedLessons}/{totalLessons} lessons</p>
            </Link>
          );
        })}
      </div>
