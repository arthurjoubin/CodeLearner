    ...
    if (!lab) {
        return (
            <div className="text-center py-8">
                ...
                <Link to="/labs" className="text-primary-600 underline font-bold uppercase text-xs">Go back to labs</Link>
            </div>
        );
    }
        ...
        <div className="page-enter min-h-[calc(100vh-80px)] flex flex-col">
            <div className="mb-4">
                <div className="flex items-center gap-2 mb-3">
                    <Link to="/labs" className="p-1.5 hover:bg-gray-100 rounded transition-colors">
                                        ...
                                        <div className="mt-3">
                                            {!isLastStep ? (
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Link to="/" className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-bold bg-gray-900 text-white rounded-lg border-2 border-gray-900 hover:bg-gray-800 transition-colors">
                                                        Back to Home
                                                    </Link>
                                                </div>
                                            )}
